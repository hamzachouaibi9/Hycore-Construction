  ...
  return (
    <section className="bg-brand-white py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        {/* Rounded container with image inside the padding */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
              ...
              <Reveal delay={0.15}>
                ...
                <div className="flex items-center gap-5">
                  ...
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-[color] duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded" aria-label="Instagram">
                  ...
                  <a
                    href="mailto:hycoreconstruction@gmail.com"
