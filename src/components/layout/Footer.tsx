        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-xs leading-relaxed text-white/50 max-w-[220px]">
              Hycore Construction is a forward-thinking construction company
          ...
          {/* Navigation */}
          <div>
            <h3 className="text-xs font-bold tracking-widest text-white mb-5 uppercase">
              Navigation
            </h3>
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-xs text-white/50 hover:text-white transition-[color] duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-xs text-white/50 hover:text-white transition-[color] duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded">
              ...
              <li>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-xs text-white/50 hover:text-white transition-[color] duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded">
              ...
              <li>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-xs text-white/50 hover:text-white transition-[color] duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded">
